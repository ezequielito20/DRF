...
from apps.products.api.views.general_views import MeasureUnitListAPIView, IndicatorListAPIView, CategoryProductSerializerListAPIView
...
urlpatterns = [
    ...
    path('category_product/', CategoryProductSerializerListAPIView.as_view(), name='category_product'),
